...
var CONFIG_DIR = process.env.PI_RELAY_HOME || process.env.CLAUDE_RELAY_HOME || path.join(os.homedir(), ".pi-relay");
var CLAYRC_PATH = path.join(os.homedir(), ".pirelayrc");
...
function socketPath() {
  if (process.platform === "win32") {
    var pipeName = process.env.CLAUDE_RELAY_HOME ? "pi-relay-dev-daemon" : "pi-relay-daemon";
