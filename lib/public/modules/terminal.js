...
function fitTerminal() {
  ...
  try {
    // Defer to requestAnimationFrame so flex layout has settled before
    // FitAddon calculates rows and cols. Prevents terminal overflow.
    requestAnimationFrame(function () {
      if (!tab.fitAddon || !tab.xterm) return;
