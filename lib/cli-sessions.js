 ...
 * Reads pi sessions from ~/.pi/agent/sessions/ and Claude sessions from
...
function listCliSessions(cwd) {
  ...
  // Try pi sessions first, fall back to Claude sessions
  var piSessionDir = path.join(os.homedir(), ".pi", "agent", "sessions");
